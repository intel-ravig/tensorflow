...
def tf_repositories(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        sha256 = "1883ccfb037bd31f916203a38e877899fc27ae10bc9ebad686f78d189ba506a7",
        strip_prefix = "oneDNN-1.8.1",
        urls = [
            "https://storage.googleapis.com/mirror.tensorflow.org/github.com/oneapi-src/oneDNN/archive/refs/tags/v1.8.1.tar.gz",
            "https://github.com/oneapi-src/oneDNN/archive/refs/tags/v1.8.1.tar.gz",
        ],
    )
